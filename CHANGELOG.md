...
- Added Mailpit v1.30 support.
- Set default Mailpit version to v1.30.
...
- Moved Mailpit v1.25 to legacy versions.
- Updated @lando/core from 3.23.26 to 3.26.2
- Updated lodash from 4.17.21 to 4.17.23
- Updated mdast-util-to-hast from 13.2.0 to 13.2.1
- Updated vite from 5.4.20 to 5.4.21
- Updated GitHub Actions (checkout v4→v6, setup-node v4→v6, create-pull-request v5→v8, add-to-project v1.0.0→v1.0.2, cache v4→v5)
